...
# install.packages('~/Documents/GitHub/tumor-evolution-HAL/EvoFreBeta')
install.packages('~/Documents/GitHub/tumor-evolution-HAL/EvoFreqBeta', repos = NULL, type="source")
library(EvoFreqBeta)
